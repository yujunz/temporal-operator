...
#RequestErrReadTimeout: {
	...
	Received:    int
	BlockFor:    int
	DataPresent: uint8 @go(,byte)
}

#RequestErrAlreadyExists: {
	Keyspace: string
	Table:    string
}

#RequestErrUnprepared: {
	StatementId: bytes @go(,[]byte)
}

#RequestErrReadFailure: {
	Consistency: #Consistency
	Received:    int
	BlockFor:    int
	NumFailures: int
...
#RequestErrFunctionFailure: {
	Keyspace: string
	Function: string
	ArgTypes: [...string] @go(,[]string)
}

// RequestErrCASWriteUnknown is distinct error for ErrCodeCasWriteUnknown.
//
// See https://github.com/apache/cassandra/blob/7337fc0/doc/native_protocol_v5.spec#L1387-L1397
#RequestErrCASWriteUnknown: {
	Consistency: #Consistency
	Received:    int
	BlockFor:    int
}
